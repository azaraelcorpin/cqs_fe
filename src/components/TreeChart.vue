...
.node .person .avat{border-radius: 50px; display: block;width:4em;height: 4em;margin:auto;overflow:hidden; background:#fff;border:1px solid #111010;box-sizing: border-box;}

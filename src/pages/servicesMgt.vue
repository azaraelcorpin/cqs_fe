    ...
    <q-page class="q-pa-sm">
        ...
        <q-card class="pa-1">
            ...
            <q-card-section class="container--fluid" style="height: 89vh;">
                        ...
                        <q-form @submit="newServices" @reset="newServicesReset">
                            ...
                            <q-page-container style="padding:10px;">
                                <div class="text-h5" style="margin: 5px;">{{ !NEW_SERVICES.id ? 'New ' : 'Update '
                                    ...
                                    Service</div>
                                <!-- type -->
                                <q-select label="Role" filled dense outlined class="q-pa-sm" color="primary"
                                    v-model="NEW_SERVICES.type" :options="['Payment', 'Release']">
                                </q-select>
                                <!-- category -->
                                <q-input required label="Category" dense outlined class="q-pa-sm" color="primary"
                                    v-model="NEW_SERVICES.category"
                                    :rules="[rules.properWordStart, rules.requiredField]">
                                </q-input>
                                ...
                                <div style="display: flex; justify-content: flex-end;">
                                    <q-btn class="q-ma-md" color="primary" v-if="NEW_SERVICES.id"
                                        type="submit">Update</q-btn>
                ...
                <!-- end dialog -->
                <!-- employee list table  -->
                <q-table class="my-sticky-header-table" :grid="$q.screen.xs" :rows="servicesList" :columns="header"
                    row-key="id" :rows-per-page-options="[10, 1, 15, 20, 25, 50, 0]" :filter="filter"
                    :style="{ height: $q.screen.xs ? '90.5%' : '96.5%', 'overflow-y': 'auto' }"
                    virtual-scroll-sticky-size-start="100">
                    <template v-slot:body-cell-action="props">
                        <q-td :props="props">
                            <q-btn color="positive" icon="edit" round flat
                                @click="showUpdateServicesDialog(props.row)"></q-btn>
